-- ====================================================================
-- EventFlow: Database Schema Definitions
-- Location: server/src/config/schema.sql
-- ====================================================================

-- ####################################################################
-- SECTION A: SUPABASE & POSTGRESQL PRODUCTION SCHEMA
-- Use this script in your Supabase SQL Editor or standard PostgreSQL.
-- ####################################################################
...
-- 6. Trigger to automatically populate profile when user registers via Supabase Auth
...
-- ####################################################################
-- SECTION B: SQLITE LOCAL / EMBEDDED ENGINE SCHEMA
-- Used by server/src/config/db.js for offline testing and local dev.
-- ####################################################################
